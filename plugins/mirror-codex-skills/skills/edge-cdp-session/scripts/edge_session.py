#!/usr/bin/env python3
"""Ensure one named, dedicated Edge CDP endpoint without touching normal Edge."""
...
def result(data: dict, cdp_http: str, started: bool, config) -> dict:
...
def main() -> int:
    ...
    if existing:
        ...
        print(json.dumps(result(data, cdp_http, False, config)))
        return 0
    ...
    if current:
        ...
        print(json.dumps(result(data, cdp_http, True, config)))
        return 0
    print(
        json.dumps(
            {
